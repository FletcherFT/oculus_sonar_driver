...
int main(int argc, char **argv){
  ...
  libg3logger::G3Logger<ROSLogSink> log_worker("reprocess_oculus_raw_data_node");
  ...
  nodelet.load(nodelet_name + "/reprocess", "oculus_sonar/reprocess_raw_data", remap, nargv);
